...
-- ------------------------------------------------------------
--  0. LIMPIEZA (ejecutar solo en desarrollo)
-- ------------------------------------------------------------
DROP TABLE IF EXISTS like_cancion       CASCADE;
DROP TABLE IF EXISTS playlist_cancion   CASCADE;
DROP TABLE IF EXISTS artista_genero     CASCADE;
...
DROP FUNCTION  IF EXISTS fn_duracion_total_playlist(INT);
DROP FUNCTION  IF EXISTS fn_canciones_por_artista(INT);
DROP FUNCTION  IF EXISTS fn_tiene_suscripcion_activa(INT);
DROP FUNCTION  IF EXISTS trg_fn_actualizar_contador_playlist();
DROP FUNCTION  IF EXISTS trg_fn_log_usuario();

DROP PROCEDURE IF EXISTS sp_registrar_usuario(VARCHAR, VARCHAR, VARCHAR);
DROP PROCEDURE IF EXISTS sp_crear_playlist(INT, VARCHAR, TEXT, BOOLEAN);
DROP PROCEDURE IF EXISTS sp_agregar_cancion_playlist(INT, INT);
DROP PROCEDURE IF EXISTS sp_cambiar_suscripcion(INT, VARCHAR);
